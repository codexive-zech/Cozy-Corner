...
const Hero = () => {
  return (
    <div className=" grid lg:grid-cols-2 gap-16 items-center mt-16">
      <div>
        <h1 className=" text-center md:text-left capitalize text-4xl md:text-6xl font-bold tracking-tight max-w-2xl">
          We are changing the way people shop
        </h1>
        <p className=" max-w-lg text-center lg:text-left text-lg mt-6 leading-8 md:leading-6">
